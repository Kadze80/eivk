...
public class OcspRequest {
    public static final Logger _log = Logger.getLogger(OcspRequest.class.getSimpleName());
    ...
    public static void validate(X509Certificate cer, String url) throws Exception {
    	_log.trace("validate");
        try {
            ...
            _log.debug("RESULT REQUEST OCSP: {0}"+ result);
            ...
            _log.debug("RESULT STATUS: {0}"+ res);
            if (res == 1)
